...
namespace AdvancedSoftware.UserInterface.Win.UserControls.Controls.Grid
{
    [ToolboxItem(true)]
    public  class MyGridControl: GridControl
    {
        protected override BaseView CreateDefaultView()
        {
            ...
            view.Appearance.HeaderPanel.ForeColor = Color.Maroon;
            view.Appearance.HeaderPanel.Font = new Font(new FontFamily("Tahoma"), 8.25f, FontStyle.Bold);
