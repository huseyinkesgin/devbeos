...
namespace AdvancedSoftware.UserInterface.Win.Functions
{
    public class TablePrintingFunctions
    {
        ...
        private static void RaporDokumu()
        {
            ...
            _tablo.OptionsPrint.PrintHeader = _dp.SutunBasliklariGoster == EvetHayir.Evet;
        ...
        private static void Link_CreateMarginalHeaderArea(object sender, CreateAreaEventArgs e)
        {
            ...
            var boldFont = new Font("Thoma", 7, FontStyle.Bold);
            var regularFont = new Font("Thoma", 7, FontStyle.Regular);
        ...
        private static void RaporuKagidaSigdir()
        {
            ...
            {
                case RaporuKagidaSigdirmaTuru.SutunlarıDaraltarakSigdir:
